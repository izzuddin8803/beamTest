...
SCHEMA = 'FULL NAME:STRING,MOBILE NUMBER:STRING,full_address:STRING,POSTAL CODE:INTEGER,state:STRING,lat:FLOAT,lng:FLOAT'
...
def convert_types(data):
    ...
    data['POSTAL CODE'] = int(data['POSTAL CODE']) if 'style' in data else None
